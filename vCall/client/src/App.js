    ...
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            ...
            <div className="callBox flex">
                <input type="text" placeholder="Metting ID/User ID" value={receiverID} onChange={e => setReceiverID(e.target.value)} className="form-input"/>
                <button onClick={() => callPeer(receiverID.toLowerCase().trim())} className="primaryButton">Call</button>
            </div>
            <div>
                To call your friend, ask them to open Hello in their browser. <br/>
